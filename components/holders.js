...
const Holders = (props) => {
  return (
    <>
      <div className={`holders-holders ${props.rootClassName} `}>
        <ul className="holders-ul list">
          <li className="holders-li list-item"></li>
        </ul>
        <div className="holders-nodata">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
            className="holders-icon1"
          >
            <g fill="none">
        ...
        <span>
          {props.text ?? (
            <Fragment>
              <span className="holders-text2">No data found</span>
            </Fragment>
          )}
        </span>
      </div>
