...
const Mobile = (props) => {
  ...
  return (
    <>
      <div className={`mobile-mobile ${props.rootClassName} ${showFooter ? 'show' : 'hide'}`}>
       <Link href='/'>
       <div className="mobile-container1">
        ...
        <div className="mobile-container2" onClick={props.openModal1}>
          <svg height="24" width="24" viewBox="0 0 24 24">
            <path
              fill="currentColor"
          ...
          <span>
            {props.text1 ?? (
              <Fragment>
                <span className="mobile-text16">NFTs</span>
              </Fragment>
            )}
          </span>
        </div>
        <div className="mobile-container3">
          ...
          <span className="mobile-text12">
            {props.text2 ?? (
              <Fragment>
                <span className="mobile-text17">Game</span>
              </Fragment>
            )}
          </span>
        </div>
        <div className="mobile-container5" onClick={props.openModal1}>
          <svg height="24" width="24" viewBox="0 0 24 24">
            <path
              fill="currentColor"
          ...
          <span>
            {props.text3 ?? (
              <Fragment>
                <span className="mobile-text18">Gifts</span>
              </Fragment>
            )}
          </span>
        </div>
        <div className="mobile-container6" onClick={props.openModal}>
          <svg height="24" width="24" viewBox="0 0 24 24">
            <path
              fill="none"
              stroke="currentColor"
          ...
          <span>
            {props.text4 ?? (
              <Fragment>
                <span className="mobile-text19">Menu</span>
              </Fragment>
            )}
          </span>
        </div>
