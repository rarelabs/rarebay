...
const TC = () => {
  ...
  return (
    <>
   <div onClick={back}  className='x'>
     
     <svg style={{ color: 'white', fill: 'white' }} xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 1024 1024">
