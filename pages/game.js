...
const Game = (props) => {
  ...
  const openModal = () => {
    ...
    const { gridOrder = [1, 2, 3], toggleLayout = () => {}, proMode = false, togglePro = () => {} } = useLayout() || {};
  return (
    <>
      ...
      {isModalOpen3 &&  <div style={{position: 'fixed', zIndex: '900', height: '100%', right: '0px', width: 'auto', overflow: 'hidden'}}><Settings toggleLayout={proMode && toggleLayout} closeModal3={closeModal3} /></div> }
